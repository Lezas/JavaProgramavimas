    ...
    public void paintComponent(Graphics g) {
        ...
        if (l != null) {
            ...
            for(int i =0;i<taskai.size();i++){
                Taskas t = taskai.get(i);
                for(int j=i+1;j<taskai.size();j++){
                    Taskas t2 = taskai.get(j);
                    Langelis l1 = t.vieta;
                    Langelis l2 = t2.vieta;
                    if(l1.getEil() == l2.getEil() && l1.getSt() == l2.getSt()){
                        kiek++;
                        break;
                    }
                }
                ...
                g.setColor(s3);
                g.fillOval(lan.getSt()*m+5+kiek*5,lan.getEil()*m+5+kiek*5 , m-15, m-15);
                g.setColor(s2);
                g.drawString(t.Vardas(),lan.getSt()*m+m/4 , lan.getEil()*m+m/2);
